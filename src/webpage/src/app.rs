...
pub struct App {
    now: DateTime<Utc>,
    mavlink_receiver: Rc<RwLock<WsReceiver>>,
    mavlink_sender: Rc<RwLock<WsSender>>,
    vehicles_receiver: Rc<RwLock<WsReceiver>>,
    /// We are not using this, but it's needed to keep the connection alive
    vehicles_sender: Rc<RwLock<WsSender>>,
    hub_messages_stats_receiver: Rc<RwLock<WsReceiver>>,
    hub_messages_stats_sender: Rc<RwLock<WsSender>>,
    hub_stats_receiver: Rc<RwLock<WsReceiver>>,
    hub_stats_sender: Rc<RwLock<WsSender>>,
    drivers_stats_receiver: Rc<RwLock<WsReceiver>>,
    drivers_stats_sender: Rc<RwLock<WsSender>>,
    parameters_receiver: Rc<RwLock<WsReceiver>>,
    parameters_sender: Rc<RwLock<WsSender>>,
    resources_receiver: Rc<RwLock<WsReceiver>>,
    resources_sender: Rc<RwLock<WsSender>>,
...
impl Default for App {
    fn default() -> Self {
        ...
        Self {
            now: Utc::now(),
            mavlink_receiver: Rc::new(RwLock::new(mavlink_receiver)),
            mavlink_sender: Rc::new(RwLock::new(mavlink_sender)),
            vehicles_receiver: Rc::new(RwLock::new(vehicles_receiver)),
            vehicles_sender: Rc::new(RwLock::new(vehicles_sender)),
            hub_messages_stats_receiver: Rc::new(RwLock::new(hub_messages_stats_receiver)),
            hub_messages_stats_sender: Rc::new(RwLock::new(hub_messages_stats_sender)),
            hub_stats_receiver: Rc::new(RwLock::new(hub_stats_receiver)),
            hub_stats_sender: Rc::new(RwLock::new(hub_stats_sender)),
            drivers_stats_receiver: Rc::new(RwLock::new(drivers_stats_receiver)),
            drivers_stats_sender: Rc::new(RwLock::new(drivers_stats_sender)),
            resources_receiver: Rc::new(RwLock::new(resources_receiver)),
            resources_sender: Rc::new(RwLock::new(resources_sender)),
            parameters_receiver: Rc::new(RwLock::new(parameters_receiver)),
            parameters_sender: Rc::new(RwLock::new(parameters_sender)),
...
impl App {
    ...
    fn process_websocket(
        &mut self,
        receiver: Rc<RwLock<WsReceiver>>,
        sender: Rc<RwLock<WsSender>>,
        path: &str,
        name: &str,
